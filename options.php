    ...
    <table class="form-table">
        ...
        <tr>
         ...
         <?php
          ...
          <i>
          <?php
           $ex2 = "{subloop-array:flex:4}flex:{headline}<br>{text}{/subloop-array:flex}<br>{subloop-array:news:4}news: <b>{news.title}</b><br> {news.text}<br>{subloop:news.image:2}newsimage: {lastmodified} id:{id}{/subloop:news.image}{/subloop-array:news}<br>{subloop-array:aspects:20}aspects:{text} aspects-image:{subloop:aspects.image:2}aspectimage: {lastmodified} id:{id}{/subloop:aspects.image}<br>{/subloop-array:aspects}--{title}<br>{subloop:image:5}imageid: {id}<br>{/subloop:image}<br>{subloop:geodata:5}geodata: {lat}{/subloop:geodata}<br>   {subloop:object3d:5}object3D: {id}{/subloop:object3d}<br>   {subloop:author:5}author: {name}{/subloop:author}<hr>";
          ...
          <i>
          <?php
           $ex3 = "{subloop-array:aspects:10}{text:ifNotEmptyAdd:: }{subloop:aspects.image:10}  {retina} {id}<br>{/subloop:aspects.image}{/subloop-array:aspects}<br>";
           echo htmlentities($ex3);
          ?>
          </i>
          <hr>
          </td>
